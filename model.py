...
worker3 = worker.Worker('sprites/worker/worker3_inv.png', [500, 300], 200,n,coin_in_second,50000,10,None,False)
worker2=worker.Worker('sprites/worker/worker2_inv.png', [400, 100], 200,n,coin_in_second,10000,2,worker3,True)
